...
class StreamCard(QFrame):
    def __init__(self, stream, audio_manager, target_devices, is_input=False, streaming_enabled=False, parent=None):
    ...
    def _apply_muted_style(self, muted: bool):
        self.mute_btn.setText("🔇 Réactiver" if muted else "🔊 Muet")
        if muted:
    ...
    def _show_fallback_icon(self, fallback_char):
