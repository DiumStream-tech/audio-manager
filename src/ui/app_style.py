...
def build_app_stylesheet() -> str:
    ...
    /* ── Settings Dialog (redesigned 0.0.3) ─────────────────────────────── */
    ...
    QWidget#changelogBlock {{
        background: transparent;
    }}

    QLabel#changelogBlockVersion {{
        font-size: 13px;
        font-weight: 700;
        color: {theme.TEXT};
    }}

    QLabel#changelogNewBadge {{
    ...
    QDialog#updateResultDialog {{
        background: {theme.BG};
        border: 1px solid {theme.BORDER};
        border-radius: 12px;
    }}

    QWidget#updateResultHeader_info,
    QWidget#updateResultHeader_success {{
        background: {theme.PANEL};
    }}

    QWidget#updateResultHeader_warning {{
        background: {theme.PANEL};
    }}

    QLabel#updateResultTitle {{
        font-size: 14px;
        font-weight: 700;
        color: {theme.TEXT};
    }}

    QFrame#updateResultSep {{
        background: {theme.BORDER_SOFT};
    }}

    QWidget#updateResultBody {{
        background: {theme.BG};
    }}

    QLabel#updateResultMessage {{
        font-size: 12px;
        color: {theme.TEXT};
        line-height: 1.5;
    }}

    QWidget#updateResultFooter {{
        background: {theme.PANEL};
        border-top: 1px solid {theme.BORDER_SOFT};
    }}
    """